...
import { deleteAllDriversAccounts, deleteDriversAccountsGroup } from '../../redux/driversAccounts/Actions';
...
function DialogDeleteDriversAccounts({ open, setOpen }) {
	...
	const deleteAll = () => {
		dispatch(deleteAllDriversAccounts)
		setOpen(false)
	}
	const deleteGroup = () => {
		let body = [];
		...
		dispatch(deleteDriversAccountsGroup(body))
		setOpen(false)
	}
	return (
		<Dialog
			...
			<DialogTitle id="alert-dialog-title">Delete DriversAccounts
			</DialogTitle>
			<DialogContent>
...
export default DialogDeleteDriversAccounts;