...
function ReleaseDriver() {
  ...
  useEffect(() => {
    const promiseDrivers = APIDriver.getBusyNames()
  ...
  return (
    <div className={classes.root}>
      {!drivers?<div>Please wait...</div>:drivers.length<=0?<div>There is not busy drivers</div>:<Grid container direction="row" justify="center" alignItems="stretch" className={classes.first}>
        <Grid item xs={12}>
