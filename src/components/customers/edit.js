...
import { editCustomer, initEditCustomer } from '../../redux/customers/Actions';
...
function EditCustomer() {
  ...
  useEffect(() => {
    ...
    const promise = APICustomer.getById(id);
    promise.then(res => {
    ...
    <div className={classes.root}>
      {!loading ?
        <Grid container direction="row" justify="center" alignItems="stretch" className={classes.first}>
          <Grid item xs={12}>
            {customers.error === "edited" ? moveToDetails() : <React.Fragment />}
            ...
            <form
              ...
              <BaseUploadImage
                ...
                bigName={recordState.customerNameEnglish}
                type="Edit"
              ...
              <Grid container>
                ...
                <Grid item xs={12} sm={5}>
                  <TextField
                    className={classes.TextField}
                    fullWidth id="customerNameEnglish"
                    value={recordState.customerNameEnglish}
                ...
                <Grid item xs={12} sm={5}>
                  <TextField
                    className={classes.TextField}
                    fullWidth id="customerNameArabic"
                    value={recordState.customerNameArabic}
                ...
                <InputLabel id="emirate-label" className={classes.PhoneInput}>Customer phone</InputLabel>
                  ...
                  className={classes.PhoneInput}
                    ...
                    name="customerPhone"
                    defaultCountry="AE"
                    value={recordState.customerPhone}
                    onChange={(e) => handleChangePhone(e, "customerPhone")} />
                </Grid>
                <Grid item xs={1} />
                <Grid item xs={12} sm={5}>
