...
import DialogDeleteVehicles from './DialogDeleteVehicles';
...
function ListVehicles() {
    ...
    const getDetailsRoute = (id) =>{
        return VEHICLE_DETAILS_ROUTE + '?&id=' + id
    }
    ...
    return (
        <div >
            ...
            <Menu
                id="simple-menu2"
                anchorEl={vehicles.selectedCount !== 0 ? actions : handleCloseActions}
                keepMounted
            ...
            <TableContainer>
                <Table>
                    <TableHead>
                        {vehicles.selectedCount !== 0 ?
                            <TableRow role="checkbox">
                                <TableCell size='small'>
                                    {vehicles.selectedCount === vehicles.vehicles.length ?
                                        <IconButton
                                ...
                                <TableCell align="left" size='small'></TableCell>
                                <TableCell align="left" size='small'></TableCell>
                                <TableCell className={classes.selectedCell}>{vehicles.selectedCount + " selected"}</TableCell>
                                <TableCell align="left" size='small'></TableCell>
                            </TableRow>
                            :
                            <TableRow role="checkbox">
                        ...
                        <TableRow classes={{ root: classes.countRow }}>
                            vehicles<span>({vehicles.count})</span>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                            ...
                            <TableRow
                                ...
                                <TableCell size='small' padding='checkbox' class={item.checked ? "" : "checkbox"}>
                                    <Checkbox
                                        ...
                                        style={{ color: '#1a73e8' }}
                                        onChange={() => {
                                            dispatch(selectVehicle(item.id))
                                        }}
                                        inputProps={{ 'aria-label': 'primary checkbox' }} />
                                </TableCell>
                                <TableCell size='small' padding='checkbox' class={item.checked ? "hideImage" : "image"}>
                                        <Avatar className={colors[index % colors.length]}>{item.name?item.name[0]:""}</Avatar>
                                </TableCell>
            ...
            <DialogDeleteVehicles open={openDelete} setOpen={setOpenDelete} />
            ...
            >
                ...
                <DialogActions>
                    ...
                    <Button
                        onClick={() => {
                            dispatch(deleteVehicle(ItemIdDelete));
