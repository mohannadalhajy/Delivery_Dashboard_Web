...
import { deleteAllClientsAccounts, deleteClientsAccountsGroup } from '../../redux/clientsAccounts/Actions';
...
function DialogDeleteClientsAccounts({ open, setOpen }) {
	...
	const deleteAll = () => {
		dispatch(deleteAllClientsAccounts)
		setOpen(false)
	}
	const deleteGroup = () => {
		let body = [];
		...
		dispatch(deleteClientsAccountsGroup(body))
		setOpen(false)
	}
	return (
		<Dialog
			...
			<DialogTitle id="alert-dialog-title">Delete ClientsAccounts
			</DialogTitle>
			<DialogContent>
...
export default DialogDeleteClientsAccounts;