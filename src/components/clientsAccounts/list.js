...
import { CLIENTS_ACCOUNTS_ROUTE, EDIT_CLIENT_ACCOUNT_ROUTE } from '../../constants';
import { deleteClientAccount, SelectAllClientsAccounts, selectClientAccount } from '../../redux/clientsAccounts/Actions';
import DialogDeleteClientsAccounts from './DialogDelete';
...
function ListClientsAccounts({ clientClientsAccounts }) {
  ...
  const toggleSelectALL = (checkType) => {
    dispatch(SelectAllClientsAccounts(checkType))
  };
  ...
  return (
    <div >
          ...
          <TableHead>
            {records.selectedCount !== 0 ?
              ...
              <TableRow role="checkbox">
                ...
                {!clientClientsAccounts ? <TableCell align="left">Company name</TableCell> : <React.Fragment />}
            ...
            <TableRow classes={{ root: classes.countRow }}>
              ClientsAccounts<span>({records.count})</span>
            </TableRow>
          </TableHead>
          <TableBody>
              ...
              <TableRow
                ...
                <TableCell size='small' padding='checkbox' class={item.checked ? "" : "checkbox"}>
                  <Checkbox
                    ...
                    style={{ color: '#1a73e8' }}
                    onChange={() => {
                      dispatch(selectClientAccount(item.id))
                    }}
                ...
                {!clientClientsAccounts ? <TableCell
                  align="left"
                ...
                <TableCell align="left" size='small' class="actions">
                  <Link
                    ...
                    to={EDIT_CLIENT_ACCOUNT_ROUTE + '?' + item.id}>
                    <IconButton
                      className={classes.button}>
      ...
      <DialogDeleteClientsAccounts open={openDelete} setOpen={setOpenDelete} />
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            onClick={() => {
              dispatch(deleteClientAccount(ItemId));
...
export default ListClientsAccounts;