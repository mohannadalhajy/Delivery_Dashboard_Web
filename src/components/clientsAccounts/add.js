...
import { addClientAccount } from '../../redux/clientsAccounts/Actions';
...
function AddClientAccount() {
  ...
  const addClick = (e) => {
    ...
    dispatch(addClientAccount(recordState));
  }
  ...
  return (
    <div className={classes.root}>
      <Grid container direction="row" justify="center" alignItems="stretch" className={classes.first}>
        <Grid item xs={12}>
          {recordsLength !== records.records.length ? history.push(CLIENTS_ACCOUNTS_ROUTE) : <div></div>}
